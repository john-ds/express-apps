...
namespace Type_Express
{
    public class ResizingAdorner : Adorner
    {
        ...
        readonly Thumb? topLeft, topRight, bottomLeft, bottomRight;
        ...
        {
            if (this.AdornedElement is not FrameworkElement adornedElement || sender is not Thumb hitThumb) return;
        ...
        {
            if (AdornedElement is not FrameworkElement adornedElement || sender is not Thumb hitThumb) return;
