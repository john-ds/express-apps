...
namespace ExpressControls
{
    ...
    public class AppTextBox : TextBox
    {
        ...
        {
            get { return Convert.ToString(GetValue(WatermarkProperty)) ?? ""; }
            set { SetValue(WatermarkProperty, value); }
        }

        public static readonly DependencyProperty HasContextMenuProperty =
            DependencyProperty.Register(
                nameof(HasContextMenu),
                typeof(bool),
                typeof(AppTextBox),
                new FrameworkPropertyMetadata(HasContextMenuPropertyChanged)
            );

        public bool HasContextMenu
        {
            get { return Convert.ToBoolean(GetValue(HasContextMenuProperty)); }
            set { SetValue(HasContextMenuProperty, value); }
        }

        public static void HasContextMenuPropertyChanged(
            DependencyObject d,
        ...
        public static readonly DependencyProperty IsWatermarkVisibleProperty =
            DependencyProperty.Register(
                ...
                typeof(bool),
                typeof(AppTextBox),
                new FrameworkPropertyMetadata(IsWatermarkVisiblePropertyChanged)
            );

        public bool IsWatermarkVisible
        {
            get { return Convert.ToBoolean(GetValue(IsWatermarkVisibleProperty)); }
            set { SetValue(IsWatermarkVisibleProperty, value); }
        }

        public static void IsWatermarkVisiblePropertyChanged(
            DependencyObject d,
            DependencyPropertyChangedEventArgs e
        ) { }
    }
